...
# Directories
working_dir = Path(__file__).parent.parent # working_dir should be DEFAME
data_root_dir = working_dir / "data/"  # Where the datasets are stored
...
api_key_path = working_dir / "config/api_keys.yaml"
api_keys = yaml.safe_load(open(api_key_path))

google_service_account_key_path = working_dir / "config/google_service_account_key.json"
